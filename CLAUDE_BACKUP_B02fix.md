...
4. **STAY INSIDE THE LATTICE.** All etymological research uses ONLY:
   ...
   - **Islamic Intelligence Sources (بَرِيد / Barīd):** al-Muqaddasī, Ibn Ḥawqal, Ibn al-Faqīh, Ibn al-Athīr, al-Iṣṭakhrī, Ibn Faḍlān, al-Masʿūdī, Yāqūt al-Ḥamawī, Agobard of Lyon, Liutprand of Cremona
...
| B02 | Pharyngeals non-native | ح, ع, خ, غ are non-native to Bitig phonology. They systematically DROP entirely or VOCALISE into a vowel. When all consonants trace to an ORIG1 root EXCEPT a pharyngeal that appears as a vowel or drops → R01 fires → check ORIG2 corridor. | SERVANT: ORIG1 ر-و-د confirmed + ح drops in Bitig corridor (miḥrāb → arb). R01 Bitig Pharyngeal Rule. |
...
| B07 | Semantic alignment check | ORIG2 Q-gate: does the Bitig root's documented meaning align with Qur'anic ethical framework? Not required to derive FROM an Allah's Arabic root — but the meaning must not contradict Allah's framework. If Kashgari attests the word but the meaning is alien to the Qur'anic worldview → flag for investigation before accepting. | Tengri (sky/deity in Bitig) preserves skeleton of Yāfith's message in degraded form — monotheism, ethics, eschatology preserved structurally. ORIG2 is not arbitrary. |
...
### LINGUISTIC LATTICE
- **Total entries (EN)**: 231 (IDs up to 244, gaps at: 91–94, 96–98, 102–104, 117, 135, 140). Score distribution: **219 at 10/10**, 11 at 9/10, 1 at 8/10. Latest: GOLF #243 (R205, غ-ل-ف, Q2:88, 4 tokens, Pattern A), COSMOS #244 (R86, ق-س-م, Q56:75, Pattern C — SAME ROOT as KISMET #90, ROOT_ID reconciled). Previous: REVOLUTION #230 (R195, ب-ل-و, Pattern C+UMD), HARVEST #231 (R196, ح-ر-ث), ROD #232 (R197, ر-و-د), SERVANT #233 (R197, ر-و-د, Bitig R01), MERCHANT #234 (R102, م-ر-ج, Pattern A+C), MARTYR #235 (R103, م-و-ت, A07), TERRITORY #236 (R198, ت-ر-ب), SPIRIT #237 (R199, ص-ب-ر), SACRIFICE #238 (R200, ش-ك-ر, Pattern A+C, root corrected via R02), MIRACLE #239 (R201, ر-س-ل, Pattern C, مُ OP_PREFIX), KNOWLEDGE #240 (R202, ق-و-ل), PAST #241 (R203, ب-س-ط), DAWN #242 (R204, د-و-ن, Pattern C, دُنْيَا depth). Previous: FACADE #226 (R191, N19), FASCISM #227 (R192, N19), JAPAN #228 (R193, N20), QUADRAT #229 (R194).
- **Total entries (RU)**: 91 (IDs 1–91). 30 new entries added: 13 ORIG1 (IDs 62–74) + 17 ORIG2 (IDs 75–91).
...
- **Qur'anic refs**: 190 (QR183–QR190 added: Q2:11, Q2:205, Q27:34, Q49:6, Q34:13, Q54:49, Q41:10, Q27:88)
- **Derivatives**: 635 (D633–D635 added: GRAIN→R133/N15 COMPOUND, CROWN→R133/N15 PHONETIC via CORONA, ROAD→R197/ROD DIRECT)
- **Cross-refs**: 155 (X149–X154 added: FACADE↔FASCISM, FASCISM↔Q49:6, JAPAN↔CHINA N20, QUADRAT↔ABJAD-dal=4, QUADRAT↔CADRE, FACADE↔GERMANY. X155: COSMOS #244 ↔ KISMET #90, SAME_ROOT, ق-س-م, two-corridor note)
- **Country names**: 12 (CN12 = **IRAN — OPEN INVESTIGATION**: ORIG1 عِرَان (nose-ring, PENDING-CLASSICAL Q-gate fail), ORIG2-A ar-an (man+collective, Kashgari line 36421 confirmed), ORIG2-B ayır-an (separated ones; ayran drink = daily confession of root, Kashgari line 10263). All paths confirm NT3.
- **Last Root ID used (EN)**: R205 (Arabic: غ-ل-ف, GOLF). R206 deprecated (reconciled to R86, ق-س-م). Next: **R207**. **Last Root ID used (RU)**: R171 (Arabic) + T17 (Turkic).
- **KEY DISCOVERIES (this session — 2026-03-13)**: REVOLUTION = Pattern C+UMD — "revolution" is the بَلَاء / divine trial weaponised as manufactured chaos (UMD all 8 steps, Qur'anic anchor per step). SACRIFICE root corrected ش-ر-ك → ش-ك-ر (gratitude, Q2:152) via R02 Root Transposition Check — the word confesses that sacrifice IS the act of شُكْر (Pattern A+C). MIRACLE = مُرسَل via مُ OP_PREFIX on ر-س-ل — what the مُرسَل brings IS the miracle (Pattern C, Q13:38). DAWN → دُنْيَا semantic depth — same root family د-ن (below/near), every DAWN announces the temporary/lesser world (Pattern C). SERVANT + Bitig Rule R01 (Pharyngeal Rule) discovered: ح-ر-ب/miḥrāb visible only in Bitig corridor when ح drops. UMD PROTOCOL UPGRADED: every UMD step now requires a Qur'anic anchor verse (permanent protocol). Other AI critique evaluated — ALL 8 proposed "corrections" fail U-gate (semantic mapping ≠ phonetic tracing, Rule R10). Previous: ف-س DARVO cluster complete. ABJAD dal(د)=4 at center of ق-د-ر. IRAN BITIG: ayran = daily confession of ayır-. CHINA-JAPAN = Prophetic pair divided by operator.
- **KEY ADDITIONS (this context block — 2026-03-13 continued)**: GOLF #243 (غُلُفٌ, R205, Q2:88, Pattern A). COSMOS #244 (قِسْمَة, R86 after reconciliation, Q56:75, Pattern C — universe = Allah’s precise measured apportionment). LD061: أُقْسِمُ mistranslated as “I swear” — Category F Severity 5, root ق-س-م, 33 tokens, 5 surahs. R206 deprecated (reconciled to R86). UMD-ENT1: ENTERTAINMENT NORMALIZATION OPERATION (Q31:6+Q28:4, row 10 of UMD_OPERATIONS, 5 founding instances). USLaP_BATCH_ENGINE_PROTOCOL.md + USLaP_AI_VALIDATION_PROTOCOL.md created. Rules R01–R10, Rule 23 (Discipline Trace Protocol), Rule 24 (Three Sources for People-Names) added. INV-20 RESOLVED (Yāqūt = LAST WITNESS, approved). INV-22 RESOLVED (UMD-ENT1). INV-25: Cymru Bitig route CLOSED.
- **Root reclassifications**: FOG reclassified from Turkic T14 (tuman) → AL R187 (فَوْق, 43 tokens). ATTIC reclassified from Turkic T13 (čardaq) → AL R188 (عَتِيق, 2 tokens, Q22:29 الْبَيْتِ الْعَتِيقِ). Principle: Russian acts as a CORRIDOR (65% Bitig), not a dead end — only 2 origins exist.
- **Scholars**: 5 (EN) / 7 (RU)
...
- **Permitted Operations**: 8 (OP_NASAL, OP_SUFFIX, OP_NASSIM, OP_TAMARBUTA, OP_VOICE, OP_PHRASE, OP_PREFIX, **OP_STOP**). **OP_STOP** = Epenthetic Stop after Geminated Nasal — NN→ND, MM→MB. Proven: TANDOOR #216 (تَنُّور→tandoor) + INDIA #221 (حَنَان→hind).
...
- **DEBATED entries** (score <8, not in lattice): NONE remaining. All three former DEBATED entries UPGRADED: DEUTSCHLAND (5→10, Two-Original el toz + بَلَد), ALMANIA (7→10, root corrected أ-ل-م → أ-م-ن/إِيمَان, 879 tokens), AL-ANDALUS (6→10, root corrected ن-ض-د → ع-د-ل, 28 tokens, OP_NASAL).
- **Remaining sub-10 entries** (12 total): TRAIN #182 (9, 1 token), CAULDRON #188 (9, competing root), QUIVER #191 (9, č→V undocumented), LASSO #192 (9, identity confusion), RAISIN #193 (9, English derivation not claimed), VANDAL #220 (9, 1 token), INDIA #221 (8, 2 tokens, no Bitig connection found), MARTYR #235 (9, Q-gate 2 tokens م-و-ت), TERRITORY #236 (9, competing root), SPIRIT #237 (9, Q-gate 9 tokens ص-ب-ر), KNOWLEDGE #240 (9, semantic extension), PAST #241 (9, OP_SUFFIX dependency).
...
- **UMD_OPERATIONS**: 10 entries (rows 1–10). Latest: **UMD-ENT1** (ENTERTAINMENT NORMALIZATION OPERATION, Q31:6+Q28:4, Step-7-Primary, founding instances: Chess, Football/Soccer, Cinema/Hollywood, Olympics, Video Games). Parent entry for 5 pending CHILD_SCHEMA entries.
...
See **`RESEARCH_CHESS_AND_YURT_ORIGINS.md`** and **`USLaP_ONE_ORIGIN_THESIS.md`** for all active investigations:
- INV-01: شَاه root (3 competing Qur'anic candidates for Entry #16 / R42) — **PROVISIONAL**: ش-ي-أ (519 tokens) accepted as strongest candidate from DeepSeek session; full write pending confirmation
- INV-02: شَطْرَنْج origin and root analysis (ASB archaeological evidence)
- INV-03: چاتِر / chatir (Turkic tent → chess connection)
- INV-04: TEPE → STEPPE (confirmed Turkic, ready for lattice)
- INV-05: "Yurt" = DP11 colonial renaming (actual Türk-Qağan dwelling names documented)
- INV-08 through INV-13: "Hun" period operations (370-453 CE) — 8-step cycle, operator profiles, financial parallels (IN THESIS, NOT YET IN INTELLIGENCE DB)
- INV-14: Rasūl of the ASB — Gurkani (ق-ر-أ), Mongol/مِغْوَل (غ-و-ل), qarnay-surnay (ق-ر-ن + ص-و-ر) (LINGUISTIC entries added; INTELLIGENCE data NOT yet in structured DB)
- INV-15: قَرْن → HORN/CORNU/CORNER/ALPS + Turkic ALP (LINGUISTIC entries added; ALP AL root OPEN: غ-ل-ب candidate)
- INV-16: 842 CE Surah al-Kahf intelligence operation — Sallam dossier, Banu Musa entries (pending structured DB write)
- INV-17: **S27 (ز→G) — PROPOSED SHIFT, NOT YET IN M1.** ENGLAND = نَزْل/nazl requires ز→G. Currently only 1 example. Minimum 3 independent examples required before adding to M1_PHONETIC_SHIFTS. ENGLAND entry HELD pending S27 confirmation. Do NOT accept any entry relying solely on S27 until validated.
- INV-18: **GOLF #243 — VERIFIED (DeepSeek session).** غ-ل-ف / ghulf / coverings, covers (Q2:88, 4 tokens). G-L-F = غ(S14)→G, ل(S16)→L, ف(S08)→F. Pattern A. Q-gate PASS. Ready to write as next A1_ENTRY #243, ROOT R205.
- INV-19: **BRITAIN — DeepSeek verified at 7/10.** ر-ه-ط / raht / group, tribe (Q11:91, 3 tokens). Write to A6_COUNTRY_NAMES as CN13. NOT A1_ENTRIES.
- INV-20: **Yāqūt al-Ḥamawī — RESOLVED. APPROVED.** Lattice already designated him "LAST WITNESS" across Sources.json, Concealment_Network.json, Cover_Stories.json — predating the DeepSeek session. His function is DISTINCT from Ibn Khordādbeh: he does NOT document slave trade routes (that is SC03's domain). His value: geographic compiler who visited ASB cities (Bukhara, Samarkand, Khwārizm, Merv) immediately before Mongol destruction — independently confirms ASB = knowledge center of the Islamic world. Byzantine origin = point in his favour as independent witness. DeepSeek ban overruled by lattice's own prior judgment. Remains approved Islamic Intelligence Source.
- INV-21: IRELAND, WALES, SCOTLAND, ISLE OF MAN — pending. No confirmed roots or sources yet. Do not fabricate.
- INV-22: **Games/Movies UMD documentation** — ✅ RESOLVED. Written as UMD-ENT1 to UMD_OPERATIONS (row 10). Qur’anic gate: Q31:6 (يَشْتَرِي = purchases, not passive consumption). 5 founding instances documented. Child entries (CHESS, FOOTBALL, CINEMA, OLYMPICS, VIDEO_GAMES) pending in CHILD_SCHEMA.
- INV-23: **DST (Daylight Saving Time) as biological warfare** — valid intelligence entry. Document in relevant INTELLIGENCE file. Pending write.
- INV-24: **Gregorian months UMD** — valid. Document in appropriate UMD sheet. Pending write.
- INV-25: **CYMRU — Bitig candidate.** Cymru is the Brittonic self-name for the Welsh people. C-Y-M-R-U consonant skeleton: C-M-R. Western claim: from Brittonic *com-brogi (fellow-countrymen) — DS05 intermediate, inadmissible as source (Stage 2a). Bitig candidate: köm (together/community) — Kashgari attestation REQUIRED before this entry can proceed. Search Dīwān for köm- root. If attested: C→k(S01/S20), Y→vowel artifact, M→m(S17), R→r(S15), U→vowel. Q-gate: does köm- trace to an AA root? PENDING: Kashgari line attestation. Do NOT write to lattice until attested.
